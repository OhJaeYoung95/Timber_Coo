...
MovingBgObj::MovingBgObj(sf::Texture& tex, sf::Vector2f spriteDir, const std::string& n, const sf::Vector2f p)
...
void MovingBgObj::Update(float dt)
{
	...
	pos.y = originalPos.y + heightY * sin(accumTime * widthY);
